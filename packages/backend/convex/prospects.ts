...
/** Create a prospect (worker) — accepts resellerId directly */
export const workerCreateProspect = mutation({
    args: {
...
/** Update prospect fields (worker) — generic patch without auth */
export const workerUpdateProspect = mutation({
    args: {
        id: v.id("prospects"),
        status: v.optional(v.union(
            v.literal("new"), v.literal("contacted"),
