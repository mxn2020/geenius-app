...
export default defineSchema({
    ...
    users: defineTable({
        ...
        role: v.optional(v.union(v.literal("superAdmin"), v.literal("user"), v.literal("reseller"))),
    ...
    projects: defineTable({
        ...
        status: v.union(v.literal("preview"), v.literal("creating"), v.literal("live"), v.literal("suspended"), v.literal("deleted")),
    ...
    jobs: defineTable({
        projectId: v.id("projects"),
        type: v.union(v.literal("create"), v.literal("upgrade"), v.literal("redeploy"), v.literal("attach_domain"), v.literal("release"), v.literal("preview"), v.literal("convert"), v.literal("campaign_send")),
    ...
    domains: defineTable({
        ...
        status: v.union(v.literal("purchased"), v.literal("configuring"), v.literal("verifying"), v.literal("active"), v.literal("failed")),
    ...
    // ─── Secrets ────────────────────────────────────────
    secrets: defineTable({
        scope: v.union(v.literal("platform"), v.literal("project"), v.literal("registrar")),
        key: v.string(),
    ...
    prospects: defineTable({
        ...
        location: v.string(),
        niche: v.string(),
        status: v.union(v.literal("new"), v.literal("contacted"), v.literal("negotiating"), v.literal("won"), v.literal("lost")),
    ...
    campaign_emails: defineTable({
        ...
        status: v.union(v.literal("queued"), v.literal("sent"), v.literal("opened"), v.literal("replied"), v.literal("bounced"), v.literal("failed")),
    ...
    call_schedules: defineTable({
        ...
        status: v.union(v.literal("scheduled"), v.literal("completed"), v.literal("cancelled"), v.literal("no_show")),
